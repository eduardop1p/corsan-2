...
export default function QRCodePixInstallments({
  ...
  const [values] = useState(splitInstallments(client.total));
    ...
    <>
                  ...
                  {values.map((item, i) => (
                    ...
                    >
                      <div className='w-full grid grid-cols-2 '>
                        <div className='border-b border-b-gray-400 border-solid w-full bg-17e3cb text-white text-[17px] h-[50px] text-center flex items-center justify-center font-bold'>
                          Valor parcela {i + 1}
                        </div>
                      ...
                      <div className='w-full grid grid-cols-2 '>
                        <div className='w-full bg-17e3cb text-white text-[17px] h-[50px] text-center flex items-center justify-center font-bold'>
                          Pagar
                        </div>
                        <div className='text-white px-4 text-base w-full bg-white h-[50px] text-center flex items-center justify-center font-bold'>
                          <div className='flex items-center justify-center gap-2 w-full'>
                            <div
                              ...
                              className='cursor-pointer w-full max-w-[200px] rounded-[4px] flex flex-col py-3 items-center justify-center bg-0027db'
                            >
      ...
      >
        ...
        >
          ...
          <button
            type='button'
            className='w-full h-12 rounded-[4px] bg-0027db flex items-center justify-center text-base text-white'
            onClick={handleCopy}
          >
            Copiar código pix
          </button>
